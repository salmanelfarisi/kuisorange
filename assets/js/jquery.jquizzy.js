    ...
    $.fn.jquizzy = function (settings) 
	{
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) 
		{
           ...
           /* if (questionsIteratorIndex !== 0) 
			{
                contentFob += '<div class="prev"><a href="#" style="color:#ffffff;"><i class="icon-arrow-left icon-white" style="margin-top:1px;"></i> <b>  </b></a></div>';
            } */
            if (questionsIteratorIndex < config.questions.length - 1) 
			{
                contentFob += '<div class="next"><a href="#" style="color:#ffffff;"><b>  </b> <i class="icon-arrow-right icon-white" style="margin-top:1px;"></i></a></div>';
            } 
			else 
			{
                contentFob += '<div class="next final"><a href="#" style="color:#ffffff;"><b>Selesai</b> <i class="icon-ok icon-white" style="margin-top:1px;"></i></a></div>';
            }
        ...
        superContainer.find('.final').click(function () {
            ...
            for (var i = 0, toLoopTill = results.length; i < toLoopTill; i++) {
                ...
                resultSet += '<div class="result-row"> Pertanyaan ke ' + (i + 1) + (results[i] === true ? "<div class='correct'><span></span></div>" : "<div class='wrong'><span></span></div>");
